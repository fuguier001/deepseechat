...
[中文](#为-dsc-做贡献) | [English](#contributing-to-dsc)

Thank you for using dsc and for every issue, pull request, and piece of feedback that helps improve it. This guide turns the contributor welcome note from [#295](https://github.com/fuguier001/deepseechat/issues/295) into a permanent repo document.

## Before You Open An Issue Or PR

1. Search first.
Check [Issues](https://github.com/fuguier001/deepseechat/issues) and [Pull requests](https://github.com/fuguier001/deepseechat/pulls) for duplicates or related discussion before starting new work.
...
- Version: `dsc --version`, npm tag, or release asset
...
Always treat the [GitHub Releases](https://github.com/fuguier001/deepseechat/releases) page as the source of truth.
...
- WeChat: `@mongorz` (mention dsc when adding)
...
感谢你使用 dsc，也感谢你通过 issue、PR 和反馈帮助项目持续改进。这份文档把 [#295](https://github.com/fuguier001/deepseechat/issues/295) 里的欢迎与参与指南正式沉淀到仓库中。

## 提交 Issue 或 PR 之前

1. 先搜索。
先查看 [Issues](https://github.com/fuguier001/deepseechat/issues) 和 [Pull requests](https://github.com/fuguier001/deepseechat/pulls)，避免重复劳动，也方便在已有讨论里继续跟进。
...
- 版本号：`dsc --version`、npm 标签或 release 资源名
...
请以 [GitHub Releases](https://github.com/fuguier001/deepseechat/releases) 页面为准。
