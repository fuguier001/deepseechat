...
function needsReinstall() {
  ...
  try {
    ...
    // Extract version from output (e.g. "dsc 1.2.2-beta.1" or "1.2.2-beta.1")
...
if (needsReinstall()) {
  console.log(`[dsc] Binary missing or outdated, installing v${EXPECTED_VER}...`);
  try {
    ...
    console.error("[dsc] Auto-install failed. Run manually: npm uninstall -g dsc && npm install -g dsc@beta");
    process.exit(1);
  }
}
