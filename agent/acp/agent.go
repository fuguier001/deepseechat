...
// by dsc's engine (not the agent), so without this the agent
...
// -- ModeSwitcher --
//
// dsc's engine treats ModeSwitcher as the point of truth for
...
// GetMode returns the mode dsc will treat as "current" when
