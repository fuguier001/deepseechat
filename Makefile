APP        := dsc
MODULE     := github.com/fuguier001/deepseechat
CMD        := ./cmd/dsc
DIST       := dist
...
#
#   make build AGENTS=dsh PLATFORMS_INCLUDE=feishu,telegram
#
...
ALL_AGENTS    := acp dsh codex cursor devin gemini iflow kimi opencode pi qoder
