...
const (
	defaultPresetsURL         = "https://raw.githubusercontent.com/fuguier001/deepseechat/main/provider-presets.json"
	fallbackPresetsURL        = "https://gitee.com/fuguier001/deepseechat/raw/main/provider-presets.json"
...
type ProviderPreset struct {
	...
	Agents        map[string]PresetAgentConfig  `json:"agents"`               // per-agent-type configuration (keys: "dsh", "codex", "gemini", "opencode", ...)
