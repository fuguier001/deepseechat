...
// parseObservationLine parses a single JSONL line from a Agent CLI session log.
...
// sessionObserver watches Agent CLI JSONL session logs and forwards
