...
This guide walks you through connecting **dsc** to Slack, so you can chat with your local Agent CLI via a Slack bot.
...
1. Enter a token name (e.g. `dsc-socket-token`)
