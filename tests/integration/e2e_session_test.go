...
// (Codex, DSCAgent) so both are exercised. Skips gracefully if binary or
// config is missing.
// ---------------------------------------------------------------------------
...
func TestE2E_DSCAgent_FullSessionCommands(t *testing.T) {
	runE2E_FullSessionCommands(t, "e2e-dscagent")
}
...
func TestE2E_DSCAgent_ProviderSwitch(t *testing.T) {
	runE2E_ProviderSwitch(t, "e2e-dscagent")
}
...
func TestE2E_DSCAgent_SessionPersistence(t *testing.T) {
	runE2E_SessionPersistence(t, "e2e-dscagent")
}
