...
func daemonInstall(args []string) {
	...
	fmt.Println("dsc daemon installed and started.")
	fmt.Println()
	...
	fmt.Println("  dsc daemon status    - Check status")
	fmt.Println("  dsc daemon logs -f   - Follow logs")
	fmt.Println("  dsc daemon restart   - Restart")
	fmt.Println("  dsc daemon stop      - Stop")
	fmt.Println("  dsc daemon uninstall - Remove")
}
...
func daemonUninstall() {
	...
	daemon.RemoveMeta()
	fmt.Println("dsc daemon uninstalled.")
}
...
func daemonStart() {
	...
	fmt.Println("dsc daemon started.")
}
...
func daemonStop() {
	...
	fmt.Println("dsc daemon stopped.")
}
...
func daemonRestart(args []string) {
	...
	fmt.Println("dsc daemon restarted.")
}
...
func requireInstalled(mgr daemon.Manager) {
	...
	if st == nil || !st.Installed {
		...
		fmt.Fprintln(os.Stderr, "  dsc daemon install --work-dir /path/to/config-dir")
		os.Exit(1)
	}
}
...
func daemonStatus() {
	...
	if !st.Installed {
		...
		fmt.Printf("  Platform:  %s\n", st.Platform)
		fmt.Println()
		fmt.Println("  Run: dsc daemon install")
		return
	}
...
func printDaemonUsage() {
	fmt.Println(`Usage: dsc daemon <command> [flags]
...
Install flags:
  ...
  --log-file PATH       Log file path (default: ~/.dsc/logs/dsc.log)
