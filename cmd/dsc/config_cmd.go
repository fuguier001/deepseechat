...
func printConfigUsage() {
	fmt.Fprintf(os.Stderr, `Usage: dsc config <subcommand>
...
Examples:
  dsc config example              Print example config
  dsc config example > config.toml  Save example config
  dsc config format               Format default config file
  dsc config fmt --config /path/to/config.toml
`)
}
